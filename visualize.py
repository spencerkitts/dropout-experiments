...
# Create 2x3 grid (with bottom-left empty)
...
# PLOT 2: Accuracy Convergence - SEPARATE LINES with distinct markers
...
# ==========================================
# ROW 2: Additional detail plots (skip position 4)
# ==========================================
...
plt.tight_layout()
plt.savefig('figures.png', dpi=200, bbox_inches='tight', facecolor='white')
plt.savefig('figures.pdf', bbox_inches='tight', facecolor='white')
print("Saved: figures.png and figures.pdf")
